...
　　　　　　　　　　<?php endif;?>
                ...
                <?php if(empty($_SESSION['user'])):?>
                  <li><a href="./register.php" class="link_a"><span><i class="fas fa-user"></i>新規登録</span></a></li>
                <?php //else:?>
                ...
                <?php if(empty($_SESSION['user'])):?>
                　<li><a href="./login.php" class="link_a"><span><i class="fas fa-lock"></i>ログイン</span></a>
                <?php else:?>
                  <li><a href="./logout.php" class="link_a"><span><i class="fas fa-lock"></i>ログアウト</span></a>
                <?php endif;?>
              </ul>
         </div><!--navi-->
    </div><!--container-->
